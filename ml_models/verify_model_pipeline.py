...
EXPORT_ONNX_PATH = ML_MODELS_DIR / "best.onnx"
TENSORRT_ENGINE_PATH = ML_MODELS_DIR / "best.trt"

def check_model_files():
    """Check if model files exist and print their status"""
    models_to_check = {
        "Pre-trained base model": ML_MODELS_DIR / "yolo11n.pt",
        "Alternative base model": ML_MODELS_DIR / "yolov8n.pt",
        "Fine-tuned model symlink": ML_MODELS_DIR / "best.pt",
